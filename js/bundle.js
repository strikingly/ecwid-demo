...
/***/ function(module, exports, __webpack_require__) {
	...
	var EcwidComponent = function (_React$Component) {
		_inherits(EcwidComponent, _React$Component);

		function EcwidComponent() {
			_classCallCheck(this, EcwidComponent);

			return _possibleConstructorReturn(this, Object.getPrototypeOf(EcwidComponent).apply(this, arguments));
		}

		_createClass(EcwidComponent, [{
			...
			value: function render() {
				return _react2.default.createElement(
					'div',
					null,
					_react2.default.createElement('div', { id: 'my-store-7780646' }),
					_react2.default.createElement('div', { id: 'productBrowser' }),
					_react2.default.createElement(
						'noscript',
						null,
						'Your browser does not support JavaScript. Please proceed to ',
						_react2.default.createElement(
							'a',
							{ href: 'https://app.ecwid.com/jsp/7780646/catalog' },
							'HTML version of this store'
						)
					)
				);
			}
		...
		return EcwidComponent;
	}(_react2.default.Component);

	var PageComponent = function (_React$Component2) {
		_inherits(PageComponent, _React$Component2);
	...
	document.getElementById('page1').addEventListener('click', function () {
		_reactDom2.default.render(_react2.default.createElement(EcwidComponent, null), content);
	});
	document.getElementById('page2').addEventListener('click', function () {
		_reactDom2.default.render(_react2.default.createElement(PageComponent, null), content);
	});
	_reactDom2.default.render(_react2.default.createElement(EcwidComponent, null), content);
